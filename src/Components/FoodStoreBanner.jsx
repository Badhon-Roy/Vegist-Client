...
const FoodStoreBanner = () => {
    return (
        <div className="bg-[#f2f2f2] lg:h-[750px] lg:flex justify-between items-center relative lg:my-36 my-8">
            ...
            <div className="flex-1 lg:p-0 p-4">
                ...
                <h1 className="lg:text-[60px] text-[30px] font-bold mb-5 lg:block hidden">Trusted Organic Food Store <br /> Food Store Conscious</h1>
